...
\vskip .4cm
\begin{observacion*}
    Observar que el algoritmo se aplica a cualquier secuencia $f=  (f_0, f_1, \ldots, f_{n-1})$ donde  no necesariamente los $f_j$ deben ser los coeficientes de un polinomio. En  todos los casos se obtiene $c= F^{-1}f$, la transformada discreta de Fourier. 
\end{observacion*}
\vskip .4cm
