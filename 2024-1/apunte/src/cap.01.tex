\begin{chapter}{Vectores}\label{chap-vectores}
    ...
    \begin{ejemplo*}
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}[scale=1.0]
                ...
                \foreach \y in {0,...,3}
                \draw (3pt,\y) -- (-3pt,\y) ;
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (-1,1);
                \node [left] at (-1,1) {$(-1,1)$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]   (0,0) -- (2,3);
                \node [right] at (2,3) {$(2,3)$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (1,4);
                \node [above] at (1,4) {$(1,4)$};
                %\draw[fill] (-1,1) circle [radius=0.04];
                %\draw[fill] (2,3) circle [radius=0.04];
                %\draw[fill] (1,4) circle [radius=0.04];
                \draw[-,loosely dotted, thick] (1,4) -- (-1,1);
                \draw[-,loosely dotted, thick] (1,4) -- (2,3);
            \end{tikzpicture}
    ...
    \begin{ejemplo*}
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}[scale=1.0]
                ...
                \foreach \y in {0,...,2}
                \draw (3pt,\y) -- (-3pt,\y) ;
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (3,1);
                \node [right] at (3,1) {$v$};
                \draw[-Latex,very thick]  (0,0) -- (1,2);
                \node [above] at (0.9,2) {$w$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (4,3);
                \node [above] at (4,3) {$v+w$};
                \draw[-,loosely dotted, thick] (4,3) -- (3,1);
                \draw[-,loosely dotted, thick] (4,3) -- (1,2);
            \end{tikzpicture}
    ...
    \begin{figure}[h]
        ...
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (1,2);
        \node [above] at (0.9,2) {$v$};
        % flecha punteada de w a v
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},loosely dotted,thick](3,1) -- (1,2);
        % vector v - w
        %\draw[fill] (-2,1) circle [radius=0.05];
        \node [above] at (-2,1) {$v-w$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (-2,1);	
        % punteada de v-w  a v
        \draw[-,loosely dotted, thick]  (1,2) -- (-2,1);	
        %\draw[dashed,thick] (1,2) -- (-2,1);	
        \end{tikzpicture}
    ...
    \begin{ejemplo*}
        ...
        \begin{center}
            \begin{tabular}{ccc}
                ...
                \draw (3pt,\y) -- (-3pt,\y) ;
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (1,2);
                \node [right] at (1.0,1.8) {$v=(1,2)$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (3,6) node[right] {$3v=(3,6)$};
                %\node [right] at (3.1,5.8) {$3v=(3,6)$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (0.5,1);
                \node [right] at (0.5,0.8) {$\frac12v=(0. 5,1)$};
                ...
                \draw (3pt,\y) -- (-3pt,\y) ;
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (1,2);
                \node [right] at (1,1.8) {$v$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (3,6);
...
\end{section}
    ...
    \end{proof}
        ...
        \begin{ejemplo*}
            ...
            \begin{figure}[h]
                ...
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0,0) -- (1,0,0);
                \node [below] at (1,0,0.1) {$e_2$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0,0) -- (0,1,0) node[anchor=west]{$e_3$};
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0,0) -- (0,0,1);
        ...
        \begin{ejemplo*} Sea $(a,b)$ un vector en $\R^2$, entonces $(-b,a)$ es un vector ortogonal a $(a,b)$ debido a que
            ...
            \begin{center}
                ...
                \draw (3pt,\y) -- (-3pt,\y) ;
                % vector w
                \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (1,3);
    ...
    \begin{figure}[h]
        ...
        \draw[thick,->] (O) -- (0,4);
        \node [right] at (1.9,3.3) {$(x,y)$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (2,3);
        %\draw (1.8,0) -- ++(0,0.2) -- ++(0.2,0);
        \draw[dashed] (2,0) -- (2,3); 
        \draw[decoration={brace,mirror,raise=5pt},decorate]
        (2,0) -- node[right=6pt] {$y$} (2,3);
        \draw[decoration={brace,mirror,raise=5pt},decorate]
    ...
    \begin{figure}[h]
        ...
        \draw[thick,->] (0,0,0) -- (0,5,0) node[above]{$z$};
        \draw[thick,->] (0,0,0) -- (0,0,5) node[anchor=north east]{$x$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0,0) -- (4,4.5,3) node[anchor=west]{$v$};
...
\begin{center}
        ...
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},thick] (0,0) -- (3,1);
        \node [right] at (3,1) {$v$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},thick,blue] (0,0) -- (1,2);
        \node [above] at (0.9,2) {$w$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},thick,blue] (0,0) -- (4,3);
        \node [above] at (4,3) {$v+w$};
        \draw[-,loosely dotted,thick] (3,1) -- (4,3);
        \draw[loosely dotted,thick,-,blue] (1,2) -- (4,3);
        \node [right,blue] at (0.1,1.4) {{\footnotesize$||w||$}};
        \node [right,blue] at (2.0,1.4) {{\footnotesize$||v+w||$}};
        \node [right, blue] at (2.1,2.65) {{\footnotesize$||v||$}};
        \end{tikzpicture}
\end{center}
...
\begin{enumex}
    ...
    \begin{section}{Vectores afines}\label{seccion-vectores-afines}
        ...
        \begin{figure}[h]
            ...
            \draw[thick,-] (-1,0) -- (4,0);
            \draw[thick,-] (0,-1) -- (0,3);
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0.7,1) -- (3,2) node[right]{$w$};
        ...
        \begin{figure}[h]
            ...
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0.7,1) -- (3,2) node[right]{\;$w$};
            \node[inner sep=1.5pt,fill,circle] at (0.7,1) {};
            %\node[inner sep=1.5pt,fill,circle] at (3,2) {};
            \node[left] at (0.7,0.8){$v$};
            ...
            %\node[inner sep=1.5pt,fill,circle] at (3-1.5,2+0.9) {};
            \node[left] at (0.7-1.5,0.8+0.9){$p$};
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (3-0.7,2-1) node[right]{\;$w-v=q-p$};
            \node[inner sep=1.5pt,fill,circle] at (0,0) {};
            %\node[inner sep=1.5pt,fill,circle] at (2.3,1) {};
            \end{tikzpicture}
        ...
        \begin{center}
            \begin{tabular}{lcl}
               ...
               %\node[inner sep=1.5pt,fill,circle] at (0.5*3,0.5*2) {};
                ...
                %\node[inner sep=1.5pt,fill,circle] at (-1.5*3+4,-1.5*2+3.5) {};
    ...
    \begin{figure}[h]
        ...
        \draw[scale=1,domain=-3:3,smooth,variable=\x,blue,thick] plot ({\x},{0.5*\x +1});
        \end{tikzpicture}
    ...
    \begin{figure}[h]
        ...
        \foreach \y in {-1,...,-1} \draw (3pt,\y) -- (-3pt,\y) node[anchor=east] {\y}; 
        \foreach \y in {1,...,2} \draw (3pt,\y) -- (-3pt,\y) node[anchor=east] {\y}; 
        \draw[scale=1,domain=-2:3,smooth,variable=\x,blue,thick] plot ({2.5},{\x});
        \end{tikzpicture}
    ...
    \begin{figure}[h]
        ...
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (\vx,\vy) node[above]{$v_0$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (\wx,\wy) node[above]{\;$v$};
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (\wx-\vx,\wy-\vy) node[right]{$v-v_0$};
        \draw[thick,blue,-] (\vx- \tab*\vx + \tab*\wx ,\vy - \tab*\vy + \tab*\wy) --  (\vx- \taa*\vx + \taa*\wx ,\vy - \taa*\vy + \taa*\wy);
        \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (\tw*\vy-\tw*\wy,\tw*\wx-\tw*\vx) node[left]{$(a,b)$};
        \draw[loosely dotted, thick,-] (0,0) -- (\rr,\ss);
        \draw[loosely dotted, thick,-] (\rrm,\ssm) -- (0,0);
...
\end{proof}
    ...
    En  el espacio $\R^2$, diremos que \eqref{eq-ecuacion-parametrica-recta} es la \textit{ecuación paramétrica} o la \textit{representación paramétrica}\index{recta en $\R^2$!ecuación paramétrica} de la recta $L$ que pasa por el punto $v$ y es paralela a $w \ne 0$.
        ...
        \begin{figure}[h]
            ...
            \node[inner sep=1.5pt,fill,circle,blue] at (\vx+\tw*\wx+0.04*\wx,\vy+\tw*\wy+0.04*\wy)  {};
            \node[right] at (\vx+\tw*\wx,\vy+\tw*\wy+0.1){$v+tw$};
            \node[inner sep=1.5pt,fill,circle,blue] at (\vx,\vy) {};
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (\vx,\vy) node[above]{$v$};
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick] (0,0) -- (\wx,\wy) node[above]{\;$w$};
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},loosely dotted, thick] (0,0) -- (\tw*\wx,\tw*\wy) node[left]{$tw$};
            \draw[loosely dotted,thick] (\tw*\wx,\tw*\wy) -- (\vx+\tw*\wx,\vy+\tw*\wy+0.1);
            \end{tikzpicture}
            \caption{Una recta en el plano.}
        ...
        \begin{figure}[h]
            ...
            \draw[thick,-] (-4,0) -- (4,0);
            \draw[thick,-] (0,-1) -- (0,2);
            \draw[thick,blue,-] (-4,3) -- (4,-1.5);
            \node[inner sep=1.5pt,fill,circle,blue] at (-3 ,2.4375) {};
            \node[inner sep=1.5pt,fill,circle,blue] at (0.5,0.46875)  {};
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (-3 ,2.4375) node[above]{$u$};
            \draw[-{Latex[black,length=3.0mm,width=2.0mm]},very thick]  (0,0) -- (0.5,0.46875) node[above]{$v$};
            \end{tikzpicture}
...
\end{enumex}
    ...
    \begin{section}{Planos en $\R^3$}\label{seccion-planos-en-r3} 
        ...
        \begin{figure}[h]
            ...
            \draw[-{Latex[black,length=2.0mm,width=1.33mm]}]   (0,0,0) -- (2*0.5,2*0.866,0) node[right]{$u$};
