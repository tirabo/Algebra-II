...
\begin{itemize}
 \item[(i)] Una matriz con coeficientes reales puede no tener autovalores reales pero sí complejos (matriz \ref{autovalores-4} y \ref{autovalores-6}) o tener ambos.
