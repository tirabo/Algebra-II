...
{\bf Caso $x_1=1$.} por las ecuaciones  ($a$),$\ldots$,($f$) obtenemos:
\begin{equation*}
  \begin{array}{rlrlrl}
    x_1 &= 1,        & x_2 &= 2,         &x_4 &= 3, \\
    x_5 &= 6,        & x_9 &= 8,         &   &\\ 
...
{\bf Caso $x_1=2$.}  Por la ecuación ($g$)   obtenemos $x_4 = 4 -2 = 2 = x_1$, lo cual no es admisible.
...
\vskip.2cm
\ref{merf-iii} El sistema homogéneo correspondiente es 
$$\begin{array}{rl}
x_2 &= 0 \\ x_3&=0,
\end{array}$$
...
\ref{merf-iv} El sistema homogéneo correspondiente  es 
$$\begin{array}{rl}
x_2&=0,
\end{array}$$
...
\vskip.2cm
\ref{merf-amp-i} El sistema no homogéneo correspondiente  es 
$$\begin{array}{rl}
x_1 +  2x_2 &= 0 \\ 0&=1.
\end{array}$$
Por lo tanto no tiene solución.
\vskip.2cm
\ref{merf-amp-ii} El sistema  correspondiente  es 
$$\begin{array}{rl}
x_1&= 2 \\x_2 &= -3,
\end{array}$$
...
\ref{sistemas-homogeneos-merf-a} La matriz asociada a este sistema es la matriz $A_1$ que escribimos más abajo y a la cual luego reducimos a una MERF.
...
\ref{sistemas-homogeneos-merf-b}
\begin{align*}
...
\ref{sistemas-homogeneos-merf-c} Este es un sistema homogéneo de 3 ecuaciones con  4 incógnitas ($x$, $y$, $z$, $t$). La matriz del sistema es la $A_3$ que mostramos en la siguiente fila y luego la reducimos a MERF:
...
\vskip .3cm
\ref{sistemas-homogeneos-merf-d} Este es un sistema no homogéneo de 3 ecuaciones y 3 incógnitas. La matriz ampliada del sistema es $[A_1|Y]$, donde $A_1$ es la matriz del inciso \ref{sistemas-homogeneos-merf-a}. Luego  para reducir $A_1$  a MERF hacemos los mismos pasos que en \ref{sistemas-homogeneos-merf-a}:
\begin{align*}
...
\vskip .3cm
\ref{sistemas-homogeneos-merf-e} Este es un sistema no homogéneo de 3 ecuaciones y 3 incógnitas. La matriz ampliada del sistema es $[A_2|Y]$ donde $A_2$ es la matriz del inciso \ref{sistemas-homogeneos-merf-b}. Luego  para reducir $A_2$  a MERF hacemos los mismos pasos que en \ref{sistemas-homogeneos-merf-b}:
\begin{align*}
...
\vskip .3cm
\ref{sistemas-homogeneos-merf-f} Este es un sistema  no homogéneo de 3 ecuaciones con  4 incógnitas. La matriz ampliada del sistema es $[A_3|Y]$ donde $A_3$ es la matriz del inciso \ref{sistemas-homogeneos-merf-c}. Luego  para reducir $A_3$  a MERF hacemos los mismos pasos que en \ref{sistemas-homogeneos-merf-c}:
\begin{align*}
...
\vskip .3cm
\ref{sistemas-con-soluciones-b} La matriz ampliada del sistema es  
\begin{equation*}
...
\vskip .3cm
\ref{sistemas-con-soluciones-c} La matriz ampliada del sistema es  
\begin{equation*}
[A_1|Y] = \left[\begin{array}{ccc|c}
 -1&-1&4&b_1\\
 1&3&8&b_2\\
...
\ref{soluciones-R-C-no-homo} Análogamente a lo realizado en el  ejercicio \ref{matriz-2115} \ref{matriz-2115-no-homo} podemos repetir la secuencia de operaciones elementales sobre el vector $\left[\begin{array}{c}1\\i\\0 \end{array}\right]$ :
...
\ref{polinomios-a} En el ejercicio \ref{polinomio} hicimos el caso  $n=3$   para un caso concreto ($p(1)=2$, $p(2) = 7$ y $p(3)=14$). Una forma de resolver el problema, basada en lo anterior, es plantear un sistema de ecuaciones donde los coeficientes del polinomio sean la incógnitas. 
 ...
 (Veremos más adelante, usando determinantes,  que si $\lambda_i \ne \lambda_j$ para $i \ne j$,  entonces siempre encontraremos un polinomio que satisfaga las condiciones del ejercicio). 
  \vskip .2cm
  \ref{polinomios-c} No es difícil generalizar \ref{polinomios-a} para cualquier $n$: la matriz ampliada del sistema de ecuaciones  correspondiente al caso  $n$ es
 $$[V|Y] =
 \left[\begin{array}{ccccc|c}
