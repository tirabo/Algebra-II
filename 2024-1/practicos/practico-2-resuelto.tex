...
\ref{polinomios-a} En el ejercicio \ref{polinomio} hicimos  $n=3$   para un caso concreto ($p(1)=2$, $p(2) = 7$ y $p(3)=14$). como en ese caso,  una forma de resolver el problema es plantear un sistema de ecuaciones donde los coeficientes del polinomio sean la incógnitas. 
 Sea 
