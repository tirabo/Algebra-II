...
\ref{otrogonales-a} $ \langle (2,3,-1) , (1, -2, -4) \rangle = 2 \cdot 1 + 3 \cdot (-2) + (-1) \cdot (-4) = 2 + (-6) + 4 = \boxed{0}$. Por lo tanto, son vectores ortogonales. 
\vskip .3cm
\ref{otrogonales-b}$ \langle (2,-1) , (1,2) \rangle = 2 \cdot 1 + (-1) \cdot 2 = 2 - 2 = \boxed{0}$. Por lo tanto, son vectores ortogonales y  su gráfica es:
\begin{center}
    \begin{tikzpicture}
...
\ref{no-nulo-ortogonal-a} $(4,3)$ es un vector no nulo ortogonal  a $(3,-4)$, pues:
$$\langle (3,-4),(4,3) \rangle = 3 \cdot 4 + (-4) \cdot 3 = 12 - 12 = \boxed{0}.$$

\ref{no-nulo-ortogonal-b} $(1,2,0)$ es un vector no nulo ortogonal a $(2,-1,4)$, pues:
