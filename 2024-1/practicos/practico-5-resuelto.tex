...
\begin{enumerate}[topsep=6pt,itemsep=.4cm]
    ...
    En el caso de la matriz \ref{autovalores-4} del ejercicio anterior, el polinomio característico es $x^2-2x+2$ como ya fue calculado en el ejercicio anterior. 
