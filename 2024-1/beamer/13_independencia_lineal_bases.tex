...
\end{frame}
    ...
    \begin{frame}{Resumen}
        ...
        Los temas de la clase se ordenan de la siguiente forma: \pause
        
        \begin{itemize}
            \item Definición de independencia lineal. \pause
            \item Definición de base (un conjunto linealmente independiente que genera el espacio).\pause
            \item Ejemplos de bases de espacios vectoriales.  \pause
        \end{itemize}
    ...
    \begin{align*}
        v_i=-\frac{\lambda_1}{\lambda_i}v_1-\cdots-\frac{\lambda_{i-1}}{\lambda_{i}}v_{i-1}-\frac{\lambda_{i+1}}{\lambda_{i}}v_{i+1}-\cdots-\frac{\lambda_n}{\lambda_i}v_n
        \end{align*}
    ...
    \begin{teorema}\label{indep-menorigual-gen}
        Sea  $w_1,\ldots,w_m$  un conjunto finito de vectores. Entonces 
        \begin{equation}
            S \subset \langle w_1,\ldots,w_m \rangle \text{ es LI } \Rightarrow |S| \le m. \label{eq-1}\tag{TI}
        \end{equation}
    \end{teorema}
    \begin{proof} 
