...
\begin{frame}
    ...
    Sea $R$ la MERF equivalente por filas a $A$. \pause
    
    \begin{itemize}
        \item Sea $r$ la cantidad de filas no nulas de $R$.\pause
        \item  or el Corolario 4.4.3 de las Notas (visto en la clase 14) las filas
        no nulas de $R$ forman una base del espacio de fila $\Rightarrow$ rango fila de $A = r$. \pause
    \end{itemize}

    \begin{itemize}
        \item Como $r$ la cantidad de filas no nulas de $R$, hay $n-r$ filas nulas en $R$.\pause
        \item  por el Corolario 4.4.3 de las Notas (visto en la clase 14) las filas
        no nulas de $R$ forman una base del espacio de fila $\Rightarrow$ rango fila de $A = r$. \pause
    \end{itemize}
...
Segundo, por el Corolario 4.4.3 de las Notas (visto en la clase 14) las filas no nulas de la MERF equivalente a $A$ forman una base del espacio fila de $A$. \pause
