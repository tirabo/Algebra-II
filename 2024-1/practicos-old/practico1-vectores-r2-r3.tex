\documentclass[11pt,spanish,makeidx,reqno]{amsbook}
\tolerance=10000

\usepackage[math]{kurier} %para cambiar la font
\usepackage{etex}
\usepackage{t1enc}
...
\begin{center} {\large \bf \'Algebra y \'Algebra II - Segundo Cuatrimestre 2020 \\  Pr\'actico 1 - Vectores en $\mathbb R^2$ y $\mathbb R^3$} \end{center}
%============================================================
\vskip .4cm
