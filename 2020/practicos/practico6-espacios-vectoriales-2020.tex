...
% \
%
% \item Sean $W_b$ y $W_c$ los subespacios de $\mathbb{R}^4$ generados por los subconjunto dados en los ejercicios \eqref{10b} y \eqref{10c}. Decidir si $W_b+W_c$ es una suma directa. En caso de que no lo sea dar un complemento de $W_b$ y otro para $W_c$.
