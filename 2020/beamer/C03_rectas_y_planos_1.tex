...
\title[Clase 3 - Rectas y planos 1]{Álgebra/Álgebra II \\ Clase 3 - Rectas y planos 1}
%\author[C. Olmos / A. Tiraboschi]{Carlos Olmos / Alejandro Tiraboschi}
\institute[]{\normalsize FAMAF / UNC
	\\[\baselineskip] ${}^{}$
	\\[\baselineskip]
}
\date[01/09/2020]{1° de sepetiembre de 2020}
...
\begin{document}
	...
	\begin{frame}
		...
		Adem\'as veremos varias maneras describir una recta en el plano.
		
		
		\
		
		Estas diapositivas están basadas en la Secciones 1.3 y 1.5 de las {\it Notas de \'Algebra II} disponibles en Classroom, siguiendo la misma numeraci\'on. All\'i se pueden encontrar m\'as detalles y el sustento te\'orico de todas nuestras afirmaciones.
	\end{frame}
