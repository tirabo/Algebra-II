...
\title[Clase 14 - Autovalores y autovectores]{Álgebra/Álgebra II \\ Clase 14 - Autovalores y autovectores}
...
\date[20/10/2020]{20 de octubre de 2020}
...
\begin{frame}{Resumen}
    ...
    \
    \pause
   El tema de esta clase  está contenido de la sección 2.9  del apunte de clase ``Álgebra II / Álgebra - Notas del teórico''.
    \end{frame}
    ...
    \begin{block}{Observación}
    Puede haber varios autovectores con el mismo autovalor.    \pause
    \end{block}
...
\end{frame}
    ...
    $
    A=
    \begin{bmatrix}  a&b\\c&d  \end{bmatrix}$, entonces $ \chi_{A}(x)=(a-x)(d-x)-bc $.
    \end{exampleblock}
    \vskip -.2cm\pause
    \begin{demostracion}\pause
        $A-x\Id=\begin{bmatrix} a-x&b\\c&d-x\end{bmatrix}$ y usamos la fórmula del determinante de una $2\times 2$. \qed
    \end{demostracion}
...
\begin{frame}
    ...
    \vskip .2cm
    la respuesta va a ser diferente. \pause
    \vskip .3cm
